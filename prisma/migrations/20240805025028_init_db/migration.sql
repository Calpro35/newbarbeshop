...
-- AddForeignKey
ALTER TABLE "BarbeshopService" ADD CONSTRAINT "BarbeshopService_barbershopId_fkey" FOREIGN KEY ("barbeshopId") REFERENCES "Barbeshop"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
